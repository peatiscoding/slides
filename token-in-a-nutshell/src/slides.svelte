<script lang="ts">
	...
	import ClassificationByNature from './sections/classification-by-nature.svelte'
	import ClassificationByResponsibility from './sections/classification-by-responsibility.svelte'
</script>
